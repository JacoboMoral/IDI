...
QT_MOC_LITERAL(3, 30, 4), // "zoom"
QT_MOC_LITERAL(4, 35, 10), // "zoomSlider"
QT_MOC_LITERAL(5, 46, 5) // "value"

    },
    "MyGLWidget\0zoomSliderInverse\0\0zoom\0"
    "zoomSlider\0value"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->zoomSliderInverse((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: _t->zoomSlider((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
...
// SIGNAL 0
int MyGLWidget::zoomSliderInverse(int _t1)
{
    int _t0 = int();
