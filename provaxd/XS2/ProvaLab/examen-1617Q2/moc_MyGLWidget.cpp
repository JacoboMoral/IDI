...
QT_MOC_LITERAL(1, 11, 8), // "setRotar"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "value"
QT_MOC_LITERAL(4, 27, 14) // "rotarPatricios"

    },
    "MyGLWidget\0setRotar\0\0value\0rotarPatricios"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setRotar((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->rotarPatricios((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::setRotar)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::setRotar(int _t1)
{
