...
void MyGLWidget::modelTransform2(){
  glm::mat4 TG(1.0);
  TG = glm::translate(TG, glm::vec3(tx1,ty1,0.0));
  TG = glm::rotate(TG, rot1, glm::vec3(0.,0.,1.));
  TG = glm::scale(TG, glm::vec3(scl,scl2,1.));
  glUniformMatrix4fv(transLoc,1,GL_FALSE,&TG[0][0]);
}
...
void MyGLWidget::keyPressEvent(QKeyEvent *e){
	...
	case Qt::Key_Up:
	    ...
	    ty += 0.1;
            break;
	case Qt::Key_P:
            rot += (float)M_PI/(float)6.;
	    rot1 -= (float)M_PI/(float)6.;
	    break;
        default: e->ignore();
    }
    update();
...
void MyGLWidget::createBuffers ()
{
  ...
  glm::vec3 Vertices3[5];  // Tres vèrtexs amb X, Y i Z
  Vertices3[0] = glm::vec3(0.0, 0.5, 0.0);
  Vertices3[1] = glm::vec3(-0.5, 0.0, 0.0);
  Vertices3[2] = glm::vec3(0.5, 0.0, 0.0);
  Vertices3[3] = glm::vec3(-0.5, -1, 0.0);
  Vertices3[4] = glm::vec3(0.5, -1, 0.0);
