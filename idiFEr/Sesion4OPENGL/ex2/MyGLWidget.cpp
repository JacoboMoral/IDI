...
/*Si fem una interaacion de canviar el vector d'up amb tecles, hauriem de cridar a
viewTransform() cada vegada que es pinta, si no ho podem fer al initializeGL()*/
...
void MyGLWidget::viewTransform () {
    ...
    glm::mat4 View = glm::lookAt (glm::vec3(0,0,1),glm::vec3(0,0,0),glm::vec3(vupx,vupy,0));
