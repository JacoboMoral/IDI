...
QT_MOC_LITERAL(1, 11, 11), // "zoom_signal"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "angle"
QT_MOC_LITERAL(4, 30, 14), // "activaRadioCam"
QT_MOC_LITERAL(5, 45, 14), // "activaRadioEsc"
QT_MOC_LITERAL(6, 60, 10), // "changeZoom"
QT_MOC_LITERAL(7, 71, 8), // "focusEsc"
QT_MOC_LITERAL(8, 80, 8) // "focusCam"

    },
    "MyGLWidget\0zoom_signal\0\0angle\0"
    "activaRadioCam\0activaRadioEsc\0changeZoom\0"
    "focusEsc\0focusCam"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->zoom_signal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->activaRadioCam(); break;
        case 2: _t->activaRadioEsc(); break;
        case 3: _t->changeZoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->focusEsc(); break;
        case 5: _t->focusCam(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::zoom_signal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::activaRadioCam)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MyGLWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::activaRadioEsc)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::zoom_signal(int _t1)
{
...
// SIGNAL 1
void MyGLWidget::activaRadioCam()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void MyGLWidget::activaRadioEsc()
{
