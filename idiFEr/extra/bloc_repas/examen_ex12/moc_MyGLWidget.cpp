...
QT_MOC_LITERAL(4, 30, 13), // "radio1persona"
QT_MOC_LITERAL(5, 44, 10), // "changeZoom"
QT_MOC_LITERAL(6, 55, 11), // "set1persona"
QT_MOC_LITERAL(7, 67, 6), // "setRed"
QT_MOC_LITERAL(8, 74, 5), // "color"
QT_MOC_LITERAL(9, 80, 8), // "setGreen"
QT_MOC_LITERAL(10, 89, 7) // "setBlue"

    },
    "MyGLWidget\0zoom_signal\0\0angle\0"
    "radio1persona\0changeZoom\0set1persona\0"
    "setRed\0color\0setGreen\0setBlue"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->radio1persona(); break;
        case 2: _t->changeZoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->set1persona(); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::radio1persona)) {
                *result = 1;
                return;
            }
        }
