...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  public slots:
    ...
    signals:
        void zoomSliderInverse(int value);
        void updateRadioButtonPatr();
        void updateRadioButtonPors();
  ...
  private:
    ...
    GLuint VAO_Por, VBO_PorPos, VBO_PorNorm, VBO_PorMatamb, VBO_PorMatdiff, VBO_PorMatspec, VBO_PorMatshin;
